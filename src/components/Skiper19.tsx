...
// LinePath component must be defined BEFORE it's used
const LinePath = ({
  className,
  scrollYProgress,
}: {
...
const Skiper19 = () => {
  ...
  Find Your Perfect <br /> Outfit with <br /> AI
</h1>

<p className="font-jakarta-sans relative z-10 max-w-2xl text-xl font-medium text-[#1F3A4B]">
  Get personalized outfit suggestions based on your style, mood, and occasion
</p>
